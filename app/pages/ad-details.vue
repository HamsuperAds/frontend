                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div v-if="ad" class="bg-white rounded-lg p-6 shadow">
                        <div class="flex items-start justify-between mb-4">
                            <h1 class="text-lg md:text-2xl font-bold text-gray-900">{{ ad.title }}</h1>
                        ...
                        <div class="space-y-3">
                            ...
                            <div v-if="!isChatting">
                                ...
                                <div v-if="showLoginMessage" class="mt-2 text-center text-sm text-red-600">
                                    Login to chat seller <NuxtLink to="/auth/login"
...
const sendMessage = async () => {
    if (!chatMessage.value.trim() || !ad.value) return;
