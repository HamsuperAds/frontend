                    ...
                    <div class="hidden md:flex items-center space-x-6">
                        <template v-if="$isLoggedIn()">
                            ...
                            <button @click="navigateTo('/messages')" class="hover:opacity-80 transition-opacity">
                                <svg class="w-5 aspect-27/22" viewBox="0 0 27 22" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M2.66675 5.33333L13.3334 12L24.0001 5.33333V2.66667L13.3334 9.33333L2.66675 2.66667M2.66675 0H24.0001C25.4801 0 26.6667 1.18667 26.6667 2.66667V18.6667C26.6667 19.3739 26.3858 20.0522 25.8857 20.5523C25.3856 21.0524 24.7073 21.3333 24.0001 21.3333H2.66675C1.9595 21.3333 1.28123 21.0524 0.78113 20.5523C0.281033 20.0522 8.01086e-05 19.3739 8.01086e-05 18.6667V2.66667C8.01086e-05 1.95942 0.281033 1.28115 0.78113 0.781048C1.28123 0.280951 1.9595 0 2.66675 0Z"
                                        fill="white" />
                                </svg>
                            </button>
                        </template>
                ...
                <form @submit.prevent="handleSearch" class="flex w-full max-w-2xl">
                    ...
                    <div class="relative flex-1">
                        <input v-model="searchQuery" type="text" placeholder="Search"
                            class="w-full border-l border-gray-300 bg-white px-4 py-3 rounded-r-md text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400" />
...
onMounted(() => {
    ...
    const interval = setInterval(fetchUnreadCount, 60000 * 10) // Every minute
