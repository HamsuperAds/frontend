...
const adLocation = computed(() => {
  if (props.ad.location) return `${props.ad.location.split(',')[0]}, ${props.ad.location.split(',')[props.ad.location.split(',').length - 1]}`;
  return `${props.ad.place}, ${props.ad.state?.name}`
})
