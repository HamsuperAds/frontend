<template>
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="text-center mb-6">
            ...
            <div v-else class="w-20 h-20 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-3">
        ...
        <!-- Navigation Links -->
        <nav class="space-y-1">
            <NuxtLink to="/account" class="flex items-center px-4 py-2 text-sm rounded-lg transition-colors"
            ...
            <NuxtLink to="/account/my-adverts" class="flex items-center px-4 py-2 text-sm rounded-lg transition-colors"
                @click="$emit('nav-click')"
            ...
            <NuxtLink to="/account/transactions"
                class="flex items-center px-4 py-2 text-sm rounded-lg transition-colors" @click="$emit('nav-click')"
            ...
            <NuxtLink to="/account/favorites" class="flex items-center px-4 py-2 text-sm rounded-lg transition-colors"
                @click="$emit('nav-click')"
            ...
            <NuxtLink to="/account/feedback" class="flex items-center px-4 py-2 text-sm rounded-lg transition-colors"
                @click="$emit('nav-click')"
            ...
            <div class="border-t border-gray-200 my-2 pt-2">
                ...
                <NuxtLink v-if="!hasVerificationRequest || canResubmit" to="/account/verification-request"
                    class="flex items-center px-4 py-2 text-sm rounded-lg transition-colors" @click="$emit('nav-click')"
            ...
            <NuxtLink to="/account/delete" class="flex items-center px-4 py-2 text-sm rounded-lg transition-colors"
                @click="$emit('nav-click')"
...
const { data: verificationStatus } = await useApi().get<VerificationResponse>('/verification-requests/my-request', {
    server: false,
    default: () => ({ data: null }),
    onResponseError() {
